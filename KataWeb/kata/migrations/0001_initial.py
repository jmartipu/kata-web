# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2018-10-04 03:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tiposDeServicio', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='kata.TiposDeServicio')),
        ...
        migrations.AddField(
            ...
            name='trabajador',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='kata.Trabajador'),
        ),
    ]
